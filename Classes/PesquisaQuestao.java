...
public class PesquisaQuestao {
    ...
    private HashMap<Integer, Map<String, Pair<Integer, Integer>>> formatoCiaran;

    //construtor
    public PesquisaQuestao () {
        Map<Integer, Map<String, Pair<Integer, Integer>>> t_docid_tf_df = new HashMap<>();
        this.formatoCiaran = t_docid_tf_df;
    }
...
//     // Score da query -> termo: score 
//     private Map<String, Double> QueryScore (Map<String, Pair<Integer, Integer>> vector, Map<String, Integer> t_freq ,Integer N) {
...
//     private Map<String, Double> DocumentScore (Map<String, Pair<Integer, Integer>> vector, Integer N) {
//         Double wt = 0.0;
//         Map<String, Double> scores = new HashMap<>();
//         for (String key: vector.keySet()) {
//             Pair<Integer, Integer> pair = vector.get(key);
